    ...
    <>
      <header
        className={[
          ...
          isTopBarFixed ? "fixed top-0 z-10 w-full" : "",
        ].join(" ")}
      >
        <div
          className={[
            "relative mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8",
          ].join(" ")}
        >
          <a className="block text-brand-primary" href="/">
          ...
          <div className="flex flex-1 items-center justify-end md:justify-between">
            <nav aria-label="Global" className="hidden md:block">
              <ul className="flex items-center gap-6 text-sm">
                {["About", "Careers", "History", "Services", "Blog"].map(
                  (el, index) => {
                    return (
                      <li key={`header-${index}`}>
                        <a
      ...
      <WithFilterList isTopBarFixed={isTopBarFixed} />
    </>
  );
}
